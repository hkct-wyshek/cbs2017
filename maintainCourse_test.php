...
<form method="get" action="dlCourseInfo_test.php">
	<TABLE BORDER=0>
	<TR>
	...
	<tr>
		<TD CLASS=CR><B>選擇校舍</B></TD>
		<TD CLASS=CL><?php 
			foreach($cpname as $key => $val){
				$campus_name = $val['name'];
			  echo "<input type=\"checkbox\" name=\"cp_name[]\" value=\"$campus_name\" checked>$campus_name<br>";
			}
		?></TD>
	</tr>
